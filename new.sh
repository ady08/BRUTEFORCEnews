...
pu='\033[37;1m' #putih
ku='\033[33;1m' #kuning
# Jangan Recode Ya ANJING
echo
echo
echo
echo $i"["$bi"•"$i"]"$me"=======___________________________=========="$i"["$bi"•"$i"]"
echo $i" |"$cy"   ===++>>> HORAS HITA SUDE <<<++==="$i"         |"
echo $i" |"$me"=======_____===___===____===____===____===___"$i"|"
...
echo $i"|"$me" 3"$i" |"$cy" BRUTEFORCE FB nicole     "$i"|"$i"    |"$cy" N"$i" |"
